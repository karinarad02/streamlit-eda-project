...
def run():
    ...
    impute_strategy = st.selectbox("Imputare numerică", ["mean", "median"])
    scaler_option = st.selectbox("Scalare", ["None", "StandardScaler", "MinMaxScaler"])
    ...
    selected_models = st.multiselect("Selectează modele", list(models.keys()))
